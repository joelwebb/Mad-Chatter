...
######################################## Uncomment after setting up cognito #######################################
...
def login():
	...
	if request.method == 'GET':
		...
		# delete this next line when you un comment the rest
...
def register():
	...
	if request.method == "POST":
		...
		######################################## Uncomment after setting up cognito #######################################
		#  check if the password is valid with cognito
...
def forgot_password():
	...
	if request.method == "POST":
		######################################## Uncomment after setting up cognito #######################################
		#  # Commented out so you don't actually reset the password until youre really ready
		#value, error_msg = start_reset_password(request.form['email']) 
		if error_msg:
			flash(error_msg)
